# This should be called rarely -- normally expected curves are added as lines
#  atop the survfit call.  It's mostly a copy of plot.survfit, but a few option
#  do not apply
plot.survexp<- function(x, conf.int= FALSE, 
