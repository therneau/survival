...
simple user error had occured in setting up the comparison.)
...
Essenially no time is spent on the ``who is in each risk set'' task. 
...
approximatedly 9*867 seconds or about 2.2 hours.  (We ran out of patience and
