...
but a critic might label the IJ approach ``pseudo pseudovalues'' and claim that
...
Other links and exploration are of course possible.
...
truncation is covariate dependent.  
