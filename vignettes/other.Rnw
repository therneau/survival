...
There are 2 primary reasons. Primarily, as a recommended package survival cannot
depend on anything outside of the base + recommended R.  
...
refer to other packages for survival data such as mstate or ggsurvfit, nor
...
and even more importantly cannot
 
A sample of vignettes in the companion package
\begin{enumerate}
...
and new companions to be added.  
\end{document}
