...
plot(sfit2[,"CR"],  xmax=48,
         lty=3, lwd=2, col=1:2, xaxt='n',
     xlab="Months post enrollment", ylab="Events")
lines(sfit1, xmax=48, fun='event', col=1:2, lwd=2)
lines(sfit3[,"transplant"], xmax=48, col=1:2, 
          lty=2, lwd=2)
...
plot(badfit, fun="event", xmax=48, xaxt='n', col=1:2, lty=2, lwd=2,
     xlab="Months from enrollment", ylab="Probability in state")
axis(1, xtime, xtime)
...
The transitions table above shows \Sexpr{sfit4$transitions[1,2]} %$ 
