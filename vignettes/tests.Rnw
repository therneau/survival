...
\begin{itemize}
  ...
  \item The SAS type 3 computation for linear models is sophisticated and
    reliable; that used in phreg is not.  I would in fact describe this 
    recent addition as a statistical disaster.
    The calculated results depend on which
    paricular coding is chosen for the factors, 
    and will normally lead to a dangerously misleading result.
\end{itemize}    
...
I fear that an openening sentence from the overview/review of Herr in 1968
is still apropos, ``In an attempt to understand how we have arrived at our
present state of ignorance, let us consider \ldots''.
...
I find the 1978 paper by Aitkin particularly useful.  
...
\begin{thebibliography}{9}
  ...
  \bibitem{D. B. Macnaughton (1992).  Which sum of squares are best in an
  ...
  The four types of estimable functions.  SAS/STAT 9.2 User's Guide,
   ...
   \bibitem{Senn} S. Senn aka Guernsey McPearson.  
