...
in 1992, Macnaughton \cite{Macnaughton1992} lists 54 references to the topic
...
I fear that an opening sentence from the 1968 overview/review of Herr
\cite{Herr68}
...
I find the 1978 paper by Aitkin \cite{Aiking78} particularly useful.  
