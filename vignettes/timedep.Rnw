...
hazards.
The code belowshows a test case using the veterans cancer data, with the
...
Stated in the gambling context, all rolette bets must be placed
\emph{before} the ball lands.
