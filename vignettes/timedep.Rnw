...
in fit2 it is 1 at time 30.  The second is incorrect.  
When a data set is expanded into a start, stop format the issue of ties
is dealt with correctly and automatically.
<<ties2>>=
@ 
