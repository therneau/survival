...
<<concordance>>=
cord.getdata <- function(object, newdata=NULL, group=NULL, need.wt, timefix=TRUE) {
...
<<concordance>>=
concordance.lm <- function(object, ..., newdata, group, ymin, ymax, 
...
concordance.survreg <- function(object, ..., newdata, group, ymin, ymax,
                                timewt=c("n", "S", "S/G", "n/G", "n/G2", "I"),
                                influence=0, ranks=FALSE, timefix=TRUE) {
    Call <- match.call()
    fits <- list(object, ...)
...
concordance.coxph <- function(object, ..., newdata, group, ymin, ymax, 
                               timewt=c("n", "S", "S/G", "n/G", "n/G2", "I"),
                               influence=0, ranks=FALSE, timefix=TRUE) {
    Call <- match.call()
    fits <- list(object, ...)
