...
This leads to a 19 state model A11, A12,\ldots A33, B11, \ldots, B33, death.
...
transition's risk set, but this is handled by stacker.
...
Further June 2026 update: The 'later addition' above was a mistake, and leads
to incorrect risk sets for the example 3 paragraphs above.  What is actually
needed is a full cmap/smap for computing, and a compressed form for inclusion
in the coxph object, for user consumption.
