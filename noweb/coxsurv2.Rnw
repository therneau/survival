...
The code has gone through multiple iteration as options and complexit
increased.
...
<<coxsurvfit>>=
coxsurv.fit1 <- function(ctype, stype, se.fit, varmat, cluster, 
                         y, x, wt, risk, position, strata, oldid,
                         transition, y2, x2, risk2, strata2, id2, unlist=TRUE) {
