...
coxph <- function(formula, data, weights, subset, na.action,
    ...
    #  levels of that variable, which we will never need), but before removing
    #  the strata variable, the latter we may need for a predict call.
    #
